...
void VideoCommingDlg::OnBnClickedOk()
{
	...
	CeLTE_SDK_DemoDlg::Instance().m_DConsoleDlg.SetPlayResID(eLTE_Tool::UnicodeToANSI(m_strResId).c_str());
	CeLTE_SDK_DemoDlg::Instance().m_DConsoleDlg.PostMessage(WM_START_REAL_PLAY);
	CDialogEx::OnOK();
}
