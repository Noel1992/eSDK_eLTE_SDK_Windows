...
void UnDispatchParamDlg::OnBnClickedOk()
{
	...
	((CEdit*)GetDlgItem(IDC_EDIT_SRCRESOURCEID))->GetWindowText(m_pUnDispatchParamInfo->strResId);
...
BOOL UnDispatchParamDlg::OnInitDialog()
{
	...
	GetDlgItem(IDC_EDIT_SRCRESOURCEID)->SetWindowText(m_pUnDispatchParamInfo->strResId);
