...
BEGIN_MESSAGE_MAP(CCallDlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON_ACCEPT, &CCallDlg::OnBnClickedAcceptCall)
...
void CCallDlg::OnBnClickedAcceptCall()
{
	// TODO: Add your control notification handler code here
	if(!m_bUse)
	{
		ELTE_INT32 iRet = ELTE_SDK_P2PRecv(eLTE_Tool::UnicodeToANSI(m_strResId).c_str());
...
{
	// TODO: Add your control notification handler code here
	ELTE_INT32 iRet = ELTE_SDK_P2PReject(eLTE_Tool::UnicodeToANSI(m_strResId).c_str());
