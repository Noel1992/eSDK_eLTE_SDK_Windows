...
typedef enum {
	...
	STATUS_FORBIDEN = 4013,     //resource unauthorized 500
	STATUS_NOT_FOUND = 4014,    //资源不存在 404
	STATUS_TEMP_UNAVAILABLE = 4015, //resource unaccessible 480
	STATUS_RES_CONFILCT = 4016, //resource conflict 450
	STATUS_UNAUTHORIZED = 4017, //unauthorized 401
	...
	STATUS_GRPPATCH_CREATEFAIL = 4032, //Patch Group创建失败
	STATUS_GRPPATCH_CANCELOK = 4033, //Patch Group取消OK
	STATUS_GRPPATCH_CANCELFAIL = 4034, //Patch Group取消失败
	STATUS_GRPPATCH_ADDOK = 4035, //Patch Group添加成员OK
	STATUS_GRPPATCH_ADDFAIL = 4036, //Patch Group添加成员FAIL
	STATUS_GRPPATCH_DELOK = 4037, //Patch Group删除成员OK
	STATUS_GRPPATCH_DELFAIL = 4038,  //Patch Group删除成员FAIL
