...
public:
	...
	**************************************************************************/
	...
	static void SplitString(const std::string& strXml, const std::string& strSplitStringOne, const std::string& strSplitStringTwo, std::string& strStart, std::string& strCentre, std::string& strEnd, int& iSplitFlag);

	static void AddResultCodeNode(CString& strResult, const CString& strFindNode);
private:
	eLTE_Tool(void);
	~eLTE_Tool(void);
};
