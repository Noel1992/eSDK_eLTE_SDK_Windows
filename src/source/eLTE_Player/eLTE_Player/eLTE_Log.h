...
#define PRODUCT_NAME			"eLTE_Player"
...
#define LOG_INTERFACE_INFO(resCode, fmt, ...) {\
	...
	if(0 == resCode)\
	{\
		Log_Interface_Info(PRODUCT_NAME,"1","",__FUNCTION__,"","","",strReqTime,strRspTime,strResCode,fmt,##__VA_ARGS__);\
	}\
	else\
	{\
		Log_Interface_Error(PRODUCT_NAME,"1","",__FUNCTION__,"","","",strReqTime,strRspTime,strResCode,fmt,##__VA_ARGS__);\
	}\
}
