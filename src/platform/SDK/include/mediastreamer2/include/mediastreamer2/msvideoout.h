...
#define MS_VIDEO_OUT_SET_WINDOW_POSITION MS_FILTER_METHOD(MS_VIDEO_OUT_ID,13,int[2])
#define MS_VIDEO_OUT_GET_WINDOW_POSITION MS_FILTER_METHOD(MS_VIDEO_OUT_ID,14,int[2])
