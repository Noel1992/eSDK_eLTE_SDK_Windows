...
#define MS_VIDEO_SIZE_576P2_W 920
#define MS_VIDEO_SIZE_576P2_H 576
#define MS_VIDEO_SIZE_720P_W 1280
#define MS_VIDEO_SIZE_720P_H 720
#define MS_VIDEO_SIZE_720P2_W 960
#define MS_VIDEO_SIZE_720P2_H 720
...
void ms_yuv_buf_rotate(MSPicture *buf, MSPicture *dst, int rotation);
...
void ms_video_ratio_reduce(int *num, int *denom);
...
typedef void (*yuv_buf_rotateFunc)(MSPicture *buf, MSPicture *dst, int rotation);
...
struct MSVideoDesc {
	...
	yuv_buf_rotateFunc yuv_buf_rotate;
};
...
void ms_create_ffmpeg_lock();
void ms_destroy_ffmpeg_lock();
void ms_acquire_ffmpeg_lock();
void ms_release_ffmpeg_lock();
...
#define	MS_FILTER_SET_PITCH	MS_FILTER_BASE_METHOD(108,int)
