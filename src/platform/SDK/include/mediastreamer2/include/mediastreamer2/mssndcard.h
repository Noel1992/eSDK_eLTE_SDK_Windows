...
/*define a MIC plug-out and recovered event SndCard event */
#define MS_FILE_SNDCARD_MIC_PLUGOUT	MS_FILTER_EVENT_NO_ARG(MS_WINSND_READ_ID,0)

#define MS_FILE_SNDCARD_MIC_PLUGIN	MS_FILTER_EVENT_NO_ARG(MS_WINSND_READ_ID,1)
/** @} */
