...
#define MS_RTP_RECV_INIT_ACCOMPANY_SESSION    MS_FILTER_METHOD(MS_RTP_RECV_ID,1,RtpSession*)
#define MS_RTP_RECV_UNINIT_ACCOMPANY_SESSION    MS_FILTER_METHOD_NO_ARG(MS_RTP_RECV_ID,2)
