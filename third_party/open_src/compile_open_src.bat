...
set JSON_PATH=%cd%\jsoncpp-src-0.6.0-rc2\source\makefiles\vs100
set JSON_LIB=%cd%\jsoncpp-src-0.6.0-rc2\lib\win32_x86_msvc\release
set JSON_DLL=%cd%\jsoncpp-src-0.6.0-rc2\bin\win32_x86_msvc\release
...
xcopy /Y "%JSON_PATH%\Release\json.lib" 				"%JSON_LIB%\"
xcopy /Y "%JSON_PATH%\Release\json.dll" 					"%JSON_DLL%\"
xcopy /Y "%JSON_PATH%\Release\json.pdb" 					"%JSON_DLL%\"
@echo .
@echo －－－－－－－－－－－－－－－－编译json End－－－－－－－－－－－－－－－－